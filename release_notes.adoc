...
Pour plus d'informations, reportez-vous à la section https://library.netapp.com/ecm/ecm_download_file/ECMLP2886292["Notes de version des outils ONTAP pour VMware vSphere 9.13"^].
