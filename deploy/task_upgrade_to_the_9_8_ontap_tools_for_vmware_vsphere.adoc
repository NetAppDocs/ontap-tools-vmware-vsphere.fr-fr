...
NOTE: À partir de la mise à niveau des outils ONTAP 9.12, le processus d'authentification et de communication de tous les systèmes de stockage passe de l'authentification de base à l'authentification par certificat en faisant automatiquement confiance aux certificats de stockage ONTAP .
