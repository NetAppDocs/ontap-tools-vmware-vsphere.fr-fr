...
* Vous auriez dû télécharger le package d'installation du plug-in NFS pour VAAI (``.vib`) depuis le site de support NetApp. https://mysupport.netapp.com/site/global/dashboard["Support NetApp"^]
