...
+
.. Accédez à l'interface de gestion de l'appliance VMware SRM à l'aide de l'URL : https://:<srm_ip>:5480[], Puis accédez à Storage Replication Adapters dans l'interface de gestion de l'appliance VMware SRM.
